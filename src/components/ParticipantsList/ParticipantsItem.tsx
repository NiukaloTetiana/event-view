...
export const ParticipantsItem: React.FC<IParticipantItemProps> = ({
  ...
  return (
    <li className="flex flex-col sm-max:w-full w-[300px] lg:w-[360px] bg-bgFirstLigtColor rounded-[24px] py-[34px]  px-[30px] sm-max:px-[20px] md:px-[22px] shadow-md transition-transform transform hover:scale-105 focus:scale-105">
